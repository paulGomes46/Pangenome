...
df1 <- read.csv("C:/Users/gomes/OneDrive/Documents/PhD/pangenome/gene_nrs_for_heaps_law.csv", header=FALSE)
df2 <- read.csv(file = "C:/Users/gomes/OneDrive/Documents/PhD/pangenome/genes_for_heaps_law.csv", header = FALSE)
...
sink("C:/Users/gomes/OneDrive/Documents/PhD/pangenome/heaps_law_alpha.txt")
cat(fit$par[2])
sink()
cat("alpha =", fit$par[2], "\n\n")